...
function filterByRating(items) {
    var itemWithRatingMorethanFour = items.filter(function (item) { return item.rating >= 4; });
...
function getMostExpensiveProduct(products) {
    if (products) {
        var highestPriceProductIndex_1 = 0;
        products.forEach(function (product, i) {
            if (highestPriceProductIndex_1 < product.price) {
                highestPriceProductIndex_1 = i;
            }
        });
        return products[highestPriceProductIndex_1];
    }
    else {
        return null;
    }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    if (n < 0) {
                        reject('you given number is negative');
                    }
                    else {
                        setTimeout(function () {
                            resolve(n * n);
